...
def main(args):
    ...
    cfg.DATASETS.TRAIN = ('coco_train_SOC',)
    cfg.DATASETS.TEST = ("coco_val_SOC", )
    cfg.DATASETS.VAL = ("coco_val_SOC", )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_classes', type=float, default=86, help='SOC have 86 classes')
    parser.add_argument('--epoch', type=int, default=30, help='epoch number')
    parser.add_argument('--iteration', type=int, default=1800, help='number of salient images in SOC')
